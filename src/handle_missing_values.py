...
if __name__ == "__main__":
    file_path = r'C:\Users\10714194\OneDrive - LTIMindtree\Desktop\py\Machine Learning Tutorial\Loan Defaultor Predictor\extracted_data\credit_risk_dataset.csv'
    df = pd.read_csv(file_path)

    # Initializing missing value handler with a specific strategy
    ...
    try:
        df_filled.to_csv('C:\\Users\\10714194\\OneDrive - LTIMindtree\\Desktop\\py\\Machine Learning Tutorial\\Loan Defaultor Predictor\\extracted_data\\fixed_missing_values.csv', index= False)  
        print(f"Updated dataset saved successfully under extracted_data folder ")    
    except Exception:
